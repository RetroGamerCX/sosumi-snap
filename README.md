...
wget https://raw.githubusercontent.com/RetroGamerCX/simple-macOS/master/simple%20macOS%20installer.sh to get the installation script.

After that, just type "sudo chmod +x 'simple macOS installer.sh'" (without the quotes owo), then "./simple macOS installer.sh" (also without the quotes -w-) and that's it, you now have the virtual machine, now you need to just install macOS on it.

IMPORTANT NOTE: someday I'll develop a version for Arch Linux and other distros...
