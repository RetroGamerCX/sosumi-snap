...
wget https://github.com/retro-64K/simple-macOS/blob/master/snap/local/firmware/OVMF_CODE.fd?raw=true
mv 'OVMF_CODE.fd?raw=true' 'OVMF_CODE.fd'
wget https://github.com/retro-64K/simple-macOS/blob/master/snap/local/firmware/OVMF_VARS-1024x768.fd?raw=true
mv 'OVMF_VARS-1024x768.fd?raw=true' OVMF_VARS-1024x768.fd
cd ~/simple-macOS
wget https://github.com/retro-64K/simple-macOS/blob/master/snap/local/ESP.qcow2?raw=true
mv 'ESP.qcow2?raw=true' ESP.qcow2
sudo apt install dmg2img --yes
dmg2img -v -i BaseSystem.dmg BaseSystem.img
wget https://raw.githubusercontent.com/retro-64K/simple-macOS/master/snap/local/bin/launch
sudo chmod +x launch
